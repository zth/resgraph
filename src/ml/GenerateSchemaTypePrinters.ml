...
let legacySchemaGeneratedHeader = "/* @generated by ResGraph legacy schema */"

let markNamedSchemaFile contents =
  namedSchemaGeneratedHeader ^ "\n\n" ^ contents

let markLegacySchemaFile contents =
  legacySchemaGeneratedHeader ^ "\n\n" ^ contents
...
let isNamedSchemaGeneratedFile ~outputFolder fileName =
  ...
  then false
    ...
    | Some contents ->
      ...
      || String.starts_with contents ~prefix:legacySchemaGeneratedHeader
